<div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            $semester=$db->get_semesterByid($kd_semester);
                            ...
                            <form method="POST" id="formEditSemester">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" name="semester" value="<?php echo $result['semester']; ?>">
                                    <input type="text" class="form-control" name="nama" value="<?php echo $result['semester']; ?>">
